          ...
          <div class="glass rounded-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 hover:border-neutral-300 dark:hover:border-neutral-700 transition-all group">
            ...
            <div class="p-4">
              ...
              <div class="grid grid-cols-3 gap-2">
                <a href="/dashboard/organizer/events/analytics/?id=${event.id}" class="px-3 py-2 text-center rounded-full border border-neutral-200 dark:border-neutral-800 hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors text-sm font-medium">
                  Stats
                </a>
